...
part of 'character_failure.dart';
...
class _$CharacterFailureTearOff {
  const _$CharacterFailureTearOff();
...
const $CharacterFailure = _$CharacterFailureTearOff();

mixin _$CharacterFailure {
  @optionalTypeArgs
...
abstract class $CharacterFailureCopyWith<$Res> {
  factory $CharacterFailureCopyWith(
          CharacterFailure value, $Res Function(CharacterFailure) then) =
      _$CharacterFailureCopyWithImpl<$Res>;
}

class _$CharacterFailureCopyWithImpl<$Res>
    implements $CharacterFailureCopyWith<$Res> {
  _$CharacterFailureCopyWithImpl(this._value, this._then);

  final CharacterFailure _value;
  // ignore: unused_field
  final $Res Function(CharacterFailure) _then;
}
...
class _$_Unexpected implements _Unexpected {
  ...
  @override
  String toString() {
    return 'CharacterFailure.unexpected()';
  }
...
class _$_InsufficientPermission implements _InsufficientPermission {
  ...
  @override
  String toString() {
    return 'CharacterFailure.insufficientPermission()';
  }
...
abstract class _InsufficientPermission implements CharacterFailure {
...
class _$_UnableToUpdate implements _UnableToUpdate {
  ...
  @override
  String toString() {
    return 'CharacterFailure.unableToUpdate()';
  }
...
abstract class _UnableToUpdate implements CharacterFailure {
