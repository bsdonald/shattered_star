...
mixin _$Character {
  ...
  MaxHP get maxHP;
  ArmorClass get armorClass;
  CombatManeuverDefense get combatManeuverDefense;
  MeleeMod get meleeMod;
...
class _$CharacterCopyWithImpl<$Res> implements $CharacterCopyWith<$Res> {
  ...
  $Res call({
    ...
    return _then(_value.copyWith(
      ...
      alignment:
          alignment == freezed ? _value.alignment : alignment as Alignment,
      deity: deity == freezed ? _value.deity : deity as Deity,
      languages:
          languages == freezed ? _value.languages : languages as Languages,
      strength: strength == freezed ? _value.strength : strength as Strength,
      dexterity:
          dexterity == freezed ? _value.dexterity : dexterity as Dexterity,
      ...
      armorClass:
          armorClass == freezed ? _value.armorClass : armorClass as ArmorClass,
      combatManeuverDefense: combatManeuverDefense == freezed
          ? _value.combatManeuverDefense
          : combatManeuverDefense as CombatManeuverDefense,
      meleeMod: meleeMod == freezed ? _value.meleeMod : meleeMod as MeleeMod,
      rangedMod:
          rangedMod == freezed ? _value.rangedMod : rangedMod as RangedMod,
      combatManeuverBonus: combatManeuverBonus == freezed
          ? _value.combatManeuverBonus
          : combatManeuverBonus as CombatManeuverBonus,
...
class _$_Character extends _Character {
  ...
  final Race race;
  @override
  final FavoredClass favoredClass;
  @override
  final Level level;
  @override
  final Gender gender;
  ...
  @override
  final CombatManeuverDefense combatManeuverDefense;
  @override
  final MeleeMod meleeMod;
  @override
  final RangedMod rangedMod;
  @override
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other is _Character &&
            ...
            (identical(other.favoredClass, favoredClass) ||
                const DeepCollectionEquality()
                    .equals(other.favoredClass, favoredClass)) &&
            ...
            (identical(other.deity, deity) ||
                const DeepCollectionEquality().equals(other.deity, deity)) &&
            ...
            (identical(other.armorClass, armorClass) ||
                const DeepCollectionEquality()
                    .equals(other.armorClass, armorClass)) &&
            (identical(other.combatManeuverDefense, combatManeuverDefense) ||
                const DeepCollectionEquality().equals(
                    other.combatManeuverDefense, combatManeuverDefense)) &&
            (identical(other.meleeMod, meleeMod) ||
                const DeepCollectionEquality()
                    .equals(other.meleeMod, meleeMod)) &&
            (identical(other.rangedMod, rangedMod) ||
                const DeepCollectionEquality()
                    .equals(other.rangedMod, rangedMod)) &&
            (identical(other.combatManeuverBonus, combatManeuverBonus) ||
                const DeepCollectionEquality()
  ...
  int get hashCode =>
      ...
      const DeepCollectionEquality().hash(deity) ^
      ...
      const DeepCollectionEquality().hash(combatManeuverDefense) ^
